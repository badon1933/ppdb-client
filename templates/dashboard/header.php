...
<head>
  ...
  <!-- JQVMap -->
  <link rel="stylesheet" href="../../vendor/AdminLTE-3.2.0/plugins/jqvmap/jqvmap.min.css">
  <!-- Theme style -->
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="../../vendor/AdminLTE-3.2.0/plugins/summernote/summernote-bs4.min.css">
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <!-- <div class="preloader flex-column justify-content-center align-items-center">
      <img class="animation__shake" src="../../vendor/AdminLTE-3.2.0/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
    </div> -->
