            ...
            <div class="col-md-4 bg-light py-3">
              <div class="row justify-content-center align-items-center">
                <div class="col mx-2">
                  ...
                  <div class="mb-3">
                    <label for="confirmPasswordFormControlInput1" class="form-label">Ulangi Password</label>
                    <input type="password" class="form-control rounded-0" id="confirmPasswordFormControlInput1" placeholder="Ulangi Password" required>
                  </div>
                  <button class="btn btn-info float-end rounded-0">Daftar</button>
                  <p class="small">Sudah punya akun? Login <a href="signin.php" class="text-decoration-none">di sini</a></p>
                </div>
              </div>
            </div>
          </div>
